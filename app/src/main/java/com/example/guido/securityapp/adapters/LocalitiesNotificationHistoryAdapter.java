...
public class LocalitiesNotificationHistoryAdapter extends AlarmHistoryAdapter {
    public LocalitiesNotificationHistoryAdapter(NotificationsHistory notificationHistory, IEventAggregator eventAggregator, Activity activity, String listenerKey) {
        super(notificationHistory, eventAggregator, activity, listenerKey);
    }
